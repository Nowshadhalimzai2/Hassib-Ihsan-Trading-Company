        ...
        <div className={`relative w-full ${className}`}>
            <div
                ...
                className={`max-h-[400px] overflow-y-auto p-4 ${
                    displayScrollbar
                        ? '[&::-webkit-scrollbar]:w-[8px] [&::-webkit-scrollbar-thumb]:rounded-[4px] [&::-webkit-scrollbar-thumb]:bg-[#aaf0ff] [&::-webkit-scrollbar-track]:bg-[#a3dcff]'
                        : 'scrollbar-hide'
                }`}
            ...
            >
                {items.map((item, index) => (
                    ...
                    >
                        <div className={`rounded-lg bg-slate-300 p-4 ${selectedIndex === index ? 'bg-slate-200' : ''} ${itemClassName}`}>
