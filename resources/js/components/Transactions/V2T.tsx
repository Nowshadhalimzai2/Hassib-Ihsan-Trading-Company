...
const V2T = ({ tellers, vendors }: { tellers: User[]; vendors: User[] }) => {
    ...
    return (
        <div className="mx-auto max-w-xl bg-white">
            <h2 className="p-4 text-center text-xl font-semibold text-slate-950">Transaction From Vendor to Teller</h2>
                ...
                <div className="">
                    <div className="grid gap-2 space-y-2">
                        ...
                        <div className="grid gap-1">
                            <Label htmlFor="source_id">From Vendor</Label>
                            <select
                                tabIndex={1}
                                name="source_id"
                                id="source_id"
                        ...
                        <div className="grid gap-1">
                            <Label htmlFor="destination_id">To Teller</Label>
                            <select
                                tabIndex={1}
                                name="destination_id"
                                id="destination_id"
