...
const V2B = ({ vendors }: { vendors: User[] }) => {
    ...
    return (
        <div className="mx-auto max-w-xl bg-white">
            <h2 className="p-4 text-center text-xl font-semibold text-slate-950">Transaction From Vendor to Business </h2>
            <p className="px-3 text-sm text-red-500">Note: The amount of money will be creditted to Business Account!</p>
