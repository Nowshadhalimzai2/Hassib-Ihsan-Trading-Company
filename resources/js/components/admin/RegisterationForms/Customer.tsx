...
export const CustomerForm = () => {
    ...
    return (
        <div className="r-gray-700 mx-auto max-w-2xl rounded-md border bg-white dark:bg-slate-900">
            <form className="flex flex-col rounded-lg p-6" onSubmit={submit}>
                <div className="">
                    <div className="grid gap-2">
                        ...
                        <Button type="submit" className="mt-2 w-full bg-slate-950" tabIndex={8} disabled={processing}>
