...
const ShowCustomer = ({ customer }: ShowCustomerProps) => {
    return (
        <div className="pt-8 dark:bg-gray-900 min-h-screen">
            <div className="mx-auto mb-4 max-w-5xl rounded-md border border-white p-2 shadow-md dark:border-gray-700 dark:bg-gray-800">
                ...
                <section className="DeleteUpdateSection flex justify-end">
                    <a
                        ...
                        className="inline-block mt-4 mr-4 rounded bg-blue-500 px-4 py-2 text-white hover:bg-blue-600"
                    >
                        Edit Customer
                    </a>
                    <form
                    ...
                    >
                        <button
                            type="submit"
                            className="inline-block mt-4 rounded bg-red-500 px-4 py-2 text-white hover:bg-red-600"
                        >
                            Delete Customer
                        </button>
                    </form>
