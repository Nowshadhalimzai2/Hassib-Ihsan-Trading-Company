...
import { PlaneLanding, PlaneTakeoff, Receipt } from 'lucide-react';
...
const Show = ({ transaction }: { transaction: UserTransaction }) => {
    return (
        <div className="flex h-screen w-full items-center justify-center bg-blue-50 p-0 md:p-4 dark:bg-gray-800">
            <div className="mx-auto max-w-7xl rounded-md border border-white px-6 py-6 shadow-lg shadow-white md:px-12 dark:bg-gray-900">
                <div className="">
                    {' '}
                    ...
                    <div className="space-x-12 py-4">
                        <span className="space-x-3">
                            ...
                            <PlaneTakeoff className="inline" />
                        </span>
                        <span className="space-x-3">
                            <PlaneLanding className="inline" />
                    ...
                    <div className="flex justify-evenly">
                        <div>
                            <span className="mr-2">
                                <Receipt className="inline" /> {transaction.amount}
                            </span>
