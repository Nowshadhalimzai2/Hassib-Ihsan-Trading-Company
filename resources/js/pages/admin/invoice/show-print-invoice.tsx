...
const ShowPrintInvoice = ({ order, invoice_number, is_invoice_exists }: Props) => {
    ...
    const breadcrumbs: BreadcrumbItem[] = [
        { title: 'invoices', href: route('invoices.show.print',order.id) },
...
export default ShowPrintInvoice;
